 ...
 */
$messages['arz'] = array(
	'spam-blacklist' => '  # اللينكات الخارجية اللي بتطابق الليستة دي ح تتمنع لما تضاف لصفحة.
  # اللستة دي بتأثر بس على الويكي دي؛ ارجع كمان للبلاك ليست العامة.
  # للوثايق شوف http://www.mediawiki.org/wiki/Extension:SpamBlacklist
  #<!-- سيب السطر دا زي ما هو كدا بالظبط--> <pre>
#
# الصيغة كدا:
#  * كل حاجة من علامة "#" لحد آخر السطر هو تعليق
#  * كل سطر مش فاضي هو تعبير منتظم بيوافق بس المضيفين جوه الوصلات الخارجية

  #</pre> <!-- سيب السطر دا زي ما هو كدا بالظبط-->',
	'spam-whitelist' => '  #<!-- سيب السطر دا زي ما هو كدا بالظبط --> <pre>
# اللينكات الخارجية اللي بتطابق اللستة دي *مش* ح تتمنع حتى لو
# كانت ممنوعة بواسطة مدخلات البلاك ليست.
#
# الصيغة كدا:
#  * كل حاجة من علامة "#" لحد آخر السطر هو تعليق
#  * كل سطر مش فاضي هو تعبير منتظم بيطابق بس المضيفين جوه الوصلات الخارجية

  #</pre> <!-- سيب السطر دا زي ما هو كدا بالظبط-->',
	'spam-invalid-lines' => '{{PLURAL:$1|السطر دا|السطور دول}} اللي في السبام بلاك ليست {{PLURAL:$1|هو تعبير منتظم |هي تعبيرات منتظمة}} مش صح و {{PLURAL:$1|محتاج|محتاجين}} تصليح قبل حفظ الصفحة:',
